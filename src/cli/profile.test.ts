...
describe("formatCliCommand", () => {
  it.each([
    ...
    },
    {
      ...
      expected: "soulclaw --profile work doctor --fix",
    },
    {
      name: "--dev is already present",
      cmd: "openclaw --dev doctor",
      env: { OPENCLAW_PROFILE: "dev" },
      expected: "soulclaw --dev doctor",
    },
