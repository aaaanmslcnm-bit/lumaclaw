      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["soulclaw gateway run", "Run the gateway in the foreground."],
            ["soulclaw gateway status", "Show service status and probe reachability."],
            ["soulclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["soulclaw gateway call health", "Call a gateway RPC method directly."],
