...
# Fork-stage note: source/url/documentation labels still point to inherited upstream
# references until SoulClaw publishes its own canonical release/docs endpoints.
...
LABEL org.opencontainers.image.source="https://github.com/openclaw/openclaw" \
  ...
  org.opencontainers.image.title="SoulClaw" \
  org.opencontainers.image.description="SoulClaw runtime container image (fork-stage, built on OpenClaw)"
...
COPY --from=build --chown=node:node /app/soulclaw.mjs .
